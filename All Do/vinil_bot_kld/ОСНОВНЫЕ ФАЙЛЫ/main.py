...
app = FastAPI(
    ...
    description="API для винилового маркетплейса",
    version="1.0.0"
)
...
async def get_records(
    ...
    try:
        ...
        cache_key = f"records_{generate_cache_key(filters)}_{limit}_{offset}"
        ...
        raw_records = sheets_client.get_all_records(filters)
